...
namespace ProyectoCrystal_AndresVeliz
{
    public partial class Tablero4 : Form
    {
        ...
        //Inicia Evetno de datagrid Keyup
            ...
            if (e.KeyCode == Keys.W || e.KeyCode == Keys.Up)
            {
                ...
                if (x > 0)
                {
                    ...
                    else if (DtgvTab[y, x].Value == M.Portal)
                    {
                        ...
                        if (GemaRec == diamante)
                        {
                            Tablero5cs TabNext = new Tablero5cs();
                            M.Jug.Punteo(50);
                            puntaje = M.Jug.puntaje;
                            labelPuntaje.Text = Convert.ToString(puntaje);
                            TabNext.vida = vida;
        ...
        //Finaliaz boton Terminar Partida
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            //Asigna la altura a las filas
                ...
                {
                    DtgvTab.Rows[a].Height = 590 / fila;
                }
